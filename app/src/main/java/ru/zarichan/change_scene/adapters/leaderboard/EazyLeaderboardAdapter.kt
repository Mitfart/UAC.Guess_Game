package ru.zarichan.change_scene.adapters.leaderboard
...
import ru.zarichan.change_scene.GameDifficulty
import ru.zarichan.change_scene.R
...
class EazyLeaderboardAdapter(private val leaders: Array<LeaderboardItem>) :
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val name: TextView = itemView.findViewById(R.id.litem__name)
        val attempts: TextView = itemView.findViewById(R.id.litem__attemps)
        val time: TextView = itemView.findViewById(R.id.litem__time)
    }
